...
echo "#" > $target_dir/FROM.txt
echo "# Contents in this directory were generated by \$CPP_ASSISTANT_ROOT/scripts/$(basename $0) on $(date +%Y/%m/%d)." >> $target_dir/FROM.txt
echo "# Edit the customized parts and add your own stuff before they can be used." >> $target_dir/FROM.txt
echo "# For more help, see documents in directory \$CPP_ASSISTANT_ROOT/docs." >> $target_dir/FROM.txt
echo "#" >> $target_dir/FROM.txt
