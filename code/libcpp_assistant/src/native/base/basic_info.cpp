...
#define CA_NEWEST_MOD_DATE          "20180708"
#endif

#ifndef CA_NEWEST_MAIN_VER
#define CA_NEWEST_MAIN_VER          "0.03.00"
#endif

#ifdef CA_SVN_VER
#define CPP_ASSISTANT_VERSION       "v" CA_NEWEST_MAIN_VER "." CA_SVN_VER "." CA_NEWEST_MOD_DATE
#else
#define CPP_ASSISTANT_VERSION       "v" CA_NEWEST_MAIN_VER ".012345." CA_NEWEST_MOD_DATE ".[Approximative]"
#endif
