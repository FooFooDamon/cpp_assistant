...
inline CA_REENTRANT bool host_is_big_endian(void)
{
...
inline int turn_around_memory(const void* src_data, const int src_len, void* dst_data, int& dst_len)
{
...
Integer byte_order_conversion(Integer src)
{
